          ...
          <>
            ...
            >
              <div className="flex justify-between items-center mb-6">
                <span className="text-2xl font-bold text-primary md:text-lg">
                  {labels.menu}
                </span>
                <button
                  onClick={() => setIsOpen(false)}
                      ...
                      <li key={link.label}>
                        {link.children ? (
                          <div className="flex flex-col">
                            <div
                              className={`flex items-center justify-between py-2 text-xl md:text-lg font-bold ${
                                isLinkActive
                                  ? "text-primary dark:text-blue-300"
                                  : "text-foreground/80 dark:text-white"
                              }`}
                            >
                              {link.label}
                            </div>
